"""Generate OT Math include snippets for the stress document."""
...
TEX_FILE = Path(__file__).parent / "stress.tex"
OUTPUT_FILE = Path(__file__).parent / "generated" / "otmath-stress-results.tex"


def render_stress_results() -> str:
    """Return deterministic OT Math snippets generated from stress.tex."""
