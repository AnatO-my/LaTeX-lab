...
_OPERATION_ALIASES = {
    ...
    "matrix_solve": MathOperation.MATRIX_SOLVE,
    "nullspace": MathOperation.MATRIX_NULLSPACE,
    "matrix_nullspace": MathOperation.MATRIX_NULLSPACE,
    "columnspace": MathOperation.MATRIX_COLUMNSPACE,
    "colspace": MathOperation.MATRIX_COLUMNSPACE,
    "matrix_columnspace": MathOperation.MATRIX_COLUMNSPACE,
    "rowspace": MathOperation.MATRIX_ROWSPACE,
    "matrix_rowspace": MathOperation.MATRIX_ROWSPACE,
    ...
    "eigenvects": MathOperation.MATRIX_EIGENVECTORS,
    "matrix_eigenvectors": MathOperation.MATRIX_EIGENVECTORS,
    ...
    "matrix_lu": MathOperation.MATRIX_LU,
    "qr": MathOperation.MATRIX_QR,
    "matrix_qr": MathOperation.MATRIX_QR,
    "cholesky": MathOperation.MATRIX_CHOLESKY,
    "matrix_cholesky": MathOperation.MATRIX_CHOLESKY,
}
